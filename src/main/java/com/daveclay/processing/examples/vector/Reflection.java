...
public class Reflection extends PApplet {
    public static void main(String[] args) {
        SketchRunner.run(new Reflection());
    }
    ...
    public void setup() {
        ...
        base2 = new PVector(width, height-150);
        createGround();

        // start ellipse at middle top of screen
        position = new PVector(width/2, 0);

        // calculate initial random vector
    ...
    public void draw() {
        ...
        fill(0, 255, 100);
        line(baseDelta.x, baseDelta.y, baseDelta.x-normal.x*100, baseDelta.y-normal.y*100);
