...
/* --------------------------------------------------------------------------
* SimpleOpenNI UserAndDepth Test
* --------------------------------------------------------------------------
...
* ----------------------------------------------------------------------------
*/
public class UserTest extends PApplet {

    public static void main(String[] args) {
        PApplet.main(UserTest.class.getName());
    }
    ...
    public void draw() {
        ...
        for (int userId : userList) {
            if (context.isTrackingSkeleton(userId)) {
                ...
                System.out.println("updating user skeleton for user " + userId);
