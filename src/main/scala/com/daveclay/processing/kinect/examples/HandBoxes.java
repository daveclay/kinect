    ...
    public void drawBoxes() {
        ...
        for (int userId : userList) {
            if (kinect.isTrackingSkeleton(userId)) {
                ...
                stroke(255, 0, 0);
                strokeWeight(5);
                drawFuckYouCunt(userId, SimpleOpenNI.SKEL_LEFT_HAND, SimpleOpenNI.SKEL_RIGHT_HAND);
            }
        }
        popMatrix();
    }

    void drawFuckYouCunt(int userId, int joint1, int joint2) {
